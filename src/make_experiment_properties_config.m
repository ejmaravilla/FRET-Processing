...
SaveParams.folder = '../results/9-14-2015 Blebbistatin/';

% General Experiment Properties
% Enter the names at the beginning of each type of experiment you want to
% assess
% SaveParams.exp_cell = {'EZR-TS'};
SaveParams.exp_cell = {'EZR-CTS_pre','EZR-TS_pre', 'EZR-CTS_post','EZR-TS_post'};
...
% %G and k settings for FRET Efficiency at 1000-1000-1500
% SaveParams.G = 2.95;
% SaveParams.k = 0.66;
